...
void LaserMapping::SubAndPubToROS(ros::NodeHandle &nh) {
    ...
    pub_odom_aft_mapped_ = nh.advertise<nav_msgs::Odometry>("/faster_lio/odometry", 100000);
...
void LaserMapping::PublishOdometry(const ros::Publisher &pub_odom_aft_mapped) {
    ...
    SetTwiststamp(odom_aft_mapped_.twist);
...
// Lsy added odometry twist data at 2025-7-21
template <typename T>
void LaserMapping::SetTwiststamp(T &out) {
